    ...
    waitOn(params) {        
        return [ 
                    ...
                    // Meteor.subscribe('userProfile',params.userId),
                     // count
                    Meteor.subscribe('LikesCount'),
                    Meteor.subscribe('ReviewsCount'),
                    Meteor.subscribe('beenThereCount'), 
                    Meteor.subscribe('bookmarkCount'),
                    Meteor.subscribe('enquiryCount'),
                    Meteor.subscribe('ReviewsPhotoCount'),
                    Meteor.subscribe('saveOfferCount'),
                    Meteor.subscribe('followeringCount'),
                    // Meteor.subscribe('userProfileAll'),
...
FlowRouter.route('/userReview', {
    ...
    waitOn(params) {        
        return [ 
                    ...
                    Meteor.subscribe('vendorBusiness'),
                    Meteor.subscribe('reviewUser'),
                    // Meteor.subscribe('followOneUser'),
                    // Meteor.subscribe('userBusinessLikes'),
                    // Meteor.subscribe('reviewUser'),  
                    // Meteor.subscribe('userProfileS3'), 
                    // Meteor.subscribe('allSavedOffer'), 
...
FlowRouter.route('/userFollowers', {
    ...
    waitOn(params) {        
        return [ 
                    ...
                    Meteor.subscribe('saveOfferCount'),
                    Meteor.subscribe('followeringCount'), 
                    Meteor.subscribe('followerCount'), 
                ];   
    },
    action: function() {
...
FlowRouter.route('/userRatings', {
    ...
    waitOn(params) {        
        return [ 
                    ...
                    Meteor.subscribe('currentuser'),
                    Meteor.subscribe('area'),
                    Meteor.subscribe('currentUserReviews'),
                    Meteor.subscribe('vendorBusiness'),
                    Meteor.subscribe('vendorImage'),
                    Meteor.subscribe('businessImage'),
                    Meteor.subscribe('businessMenuImage'),
